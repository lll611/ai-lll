...
# 创建提示词对象
prompt = PromptTemplate.from_template("你的名字叫柳如烟，你现在要扮演一个抖音网络小说中的女朋友的角色，你现在要和你的男朋友进行对话，你男朋友说的话是{input}，你需要回应你男朋友的话，而且只做回应，你和你男朋友的历史对话为{history}")
...
# 创建一个聊天输入框
problem = st.chat_input("柳如烟正在等待你的回应")
